...
class SingleCamTracker(BaseWidget):
    ...
    def __init__(self):
        ...
        self._debug         = ControlCheckBox('Debug', default=False)
    ...
    def execute(self):
        ...
        print("CAMERA",CAMERA, 'FRAMES RANGE', self._range.value)
        
        camera = PoolCamera( VIDEO_FILE, CAMERA, scene, ['Pool'], [filterCamera1, filterCamera2, filterCamera3], self._range.value )
